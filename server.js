...
app.post(['/', '/login', '/signup', '/addgrant', '/editgrant/:id', '/deletegrant/:id', '/deleteresearcher/:id','/confirmmatch/:id', '/confirmrecalculation', '/addclusters', '/addcode', '/removecode', '/editresearcher/:id'], routes)
